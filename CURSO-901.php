...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['CANTIDAD_ALUMNOS_CURSO'])) {
        ...
        if ($stmt->execute()) {
            // Redirigir a CURSO-901.php después de la actualización exitosa
            header("Location: CURSO-901.php");
        ...
        if ($stmt->execute()) {
            ...
            // Redirigir a CURSO-901.php después de la inserción exitosa
            header("Location: CURSO-901.php");
            exit(); // Terminar el script después de la redirección
        } else {
        ...
        <article>
            ...
            <section>
                ...
                <dialog id="modal">
                    ...
                    <form method="POST" action="CURSO-901.php">
