...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['CANTIDAD_ALUMNOS_CURSO'])) {
        ...
        if ($stmt->execute()) {
            // Redirigir a CURSO-402.php después de la actualización exitosa
            header("Location: CURSO-402.php");
        ...
        if ($stmt->execute()) {
            ...
            // Redirigir a CURSO-402.php después de la inserción exitosa
            header("Location: CURSO-402.php");
            exit(); // Terminar el script después de la redirección
        } else {
        ...
        <article>
            ...
            <section>
                ...
                <dialog id="modal">
                    ...
                    <form method="POST" action="CURSO-402.php">
