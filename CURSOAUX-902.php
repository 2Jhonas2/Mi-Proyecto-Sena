...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['CANTIDAD_ALUMNOS_CURSO'])) {
        ...
        if ($stmt->execute()) {
            // Redirigir a CURSOAUX-902.php después de la actualización exitosa
            header("Location: CURSOAUX-902.php");
        ...
        if ($stmt->execute()) {
            ...
            // Redirigir a CURSOAUX-902.php después de la inserción exitosa
            header("Location: CURSOAUX-902.php");
            exit(); // Terminar el script después de la redirección
        } else {
        ...
        <article>
            ...
            <section>
                ...
                <dialog id="modal1">
                    ...
                    <form method="POST" action="CURSOAUX-902.php">
